...
# Analyze log levels
# Num 1
log_level_counts = parsed_logs.groupBy('level').count().withColumnRenamed('level', 'log_level')
log_level_counts.show()
log_level_counts.write.mode('overwrite').csv('data/output/problem1_counts.csv')
...
random_sample.show()
random_sample.write.mode('overwrite').csv('data/output/problem1_sample.csv')
